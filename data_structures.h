...
int i;
	for(i=0;i<symbIndex;i++)
		if(strcmp(symbtab[i].symbol,s)==0)
			return symbtab[i].times;

	return -1;

}
void insrtSymTab(char *s, int val){
int i;
    for(i=0;i<symbIndex;i++)
        if(strcmp(symbtab[i].symbol,s)==0)
	        {if(symbtab[i].pre==0)
	...
	symbtab[symbIndex].times=1;
	symbtab[symbIndex].pre=val;
	symbIndex++;	
...
void dispSymTab(){
	...
	{
	printf("\t************SYMBOL TABLE************\n");
	printf("\t-------SYMBOL--------------LOCCTR----hexadecimal--\n");
	printf("\t--------------------------------------------------\n");
	for(i=0;i<symbIndex;i++){
		if(symbtab[i].pre==0)	
		{
		printf("\t|  %-20s  |",symbtab[i].symbol);
		printf("| %6d |     ",symbtab[i].value);
		tohex(symbtab[i].value);		
		printf("   |\n");
		}	
}
	printf("\t--------------------------------------------------\n");
